...
namespace MainQuestNoble
{
    ...
    public class MainQuestNobleTalkBehavior
    {
        ...
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            codesToInsert.Add(new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(MainQuestNobleTalkBehavior), "TrackNoble", new Type[] { typeof(CharacterObject) })));
